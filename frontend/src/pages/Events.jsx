        ...
        <div className="max-w-xl w-full">
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-gray-200 mb-6">
              Igniting Minds, Creating Impact
            </h3>

            {/* Subtitle */}
            <p className="text-gray-400 text-sm md:text-base leading-relaxed mb-8 font-light">
              The flagship speaker lineup, schedule timelines, and exclusive ticket details are currently being finalized. The official countdown to the KARE event series will be unlocked here soon!
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button
                onClick={() => navigate('/apply/speaker')}
