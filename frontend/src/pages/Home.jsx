...
const Home = () => {
  ...
  const events = [
    { title: <><span className="text-ted-red font-bold">TEDx</span><span className="text-white font-light">KARE</span> Big Bang</>, date: 'October 3, 2026', location: 'KARE Main Auditorium' },
  ];
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm py-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-200 mt-0.5">October 3, 2026</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-black border border-gray-800 flex items-center justify-center text-ted-red">
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 border-t border-b border-gray-800 py-4 text-sm">
                <div>
                  ...
                  <p className="font-semibold text-gray-200 mt-1">October 3, 2026 · 04:00 PM IST</p>
                </div>
                <div>
